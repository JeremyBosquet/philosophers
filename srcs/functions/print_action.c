...
/*   Updated: 2022/01/25 13:54:01 by jbosquet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_action(int action, int philo_id, t_philos *philos)
{
	...
	if (!philos->all_ate && philos->started)
	{
		...
		else if (action == SLEEP && !philos->all_ate && philos->started)
			printf("%d %d %s\n", time, philo_id, "is sleeping");
		else if (action == THINK && !philos->all_ate && philos->started)
